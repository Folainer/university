class IterationAlgorithm {
    ...
    public static findRoot(error: number, initialValue: number = 0.5) : number {
    ...
    public static printRoot(error: number, initialValue: number = 0.5) : void {
...
class ChordAlgorithm {
    ...
    public static findRoot(error: number, x0: number = 0, x1: number = 1) : number | null {
        this.iterationCount = 0
    ...
    public static printRoot(error: number, x0: number = 0, x1: number = 1) : void {
